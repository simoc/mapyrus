...
public class Statement
{
	...
	public static final int BOX = 19;
	public static final int HEXAGON = 20;
	public static final int TRIANGLE = 21;
	public static final int ADDPATH = 22;
	public static final int CLEARPATH = 23;
	public static final int CLOSEPATH = 24;
	public static final int SAMPLEPATH = 25;
	public static final int STRIPEPATH = 26;
	public static final int SHIFTPATH = 27;
	public static final int SINKHOLE = 28;
	public static final int GUILLOTINE = 29;
	public static final int ROUNDPATH = 30;
	public static final int STROKE = 31;
	public static final int FILL = 32;
	public static final int PROTECT = 33;
	public static final int UNPROTECT = 34;
	...
	public static final int ROTATE = 39;
	public static final int WORLDS = 40;
	public static final int PROJECT = 41;
	public static final int DATASET = 42;
	public static final int FETCH = 43;
	public static final int NEWPAGE = 44;
	...
	public static final int LEGEND = 49;
	...
	static
	{
		...
		mStatementTypeLookup.put("roundpath", new Integer(ROUNDPATH));
