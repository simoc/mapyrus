...
public class Statement
{
	...
	public static final int BEZIER = 20;
	public static final int WEDGE = 21;
	public static final int SPIRAL = 22;
	public static final int BOX = 23;
	public static final int ROUNDEDBOX = 24;
	public static final int BOX3D = 25;
	public static final int HEXAGON = 26;
	public static final int PENTAGON = 27;
	public static final int TRIANGLE = 28;
	public static final int STAR = 29;
	public static final int ADDPATH = 30;
	public static final int CLEARPATH = 31;
	public static final int CLOSEPATH = 32;
	public static final int SAMPLEPATH = 33;
	public static final int STRIPEPATH = 34;
	public static final int SHIFTPATH = 35;
	public static final int PARALLELPATH = 36;
	public static final int SELECTPATH = 37;
	public static final int SINKHOLE = 38;
	public static final int GUILLOTINE = 39;
	public static final int STROKE = 40;
	public static final int FILL = 41;
	public static final int GRADIENTFILL = 42;
	public static final int PROTECT = 43;
	public static final int UNPROTECT = 44;
	public static final int CLIP = 45;
	public static final int LABEL = 46;
	public static final int FLOWLABEL = 47;
	public static final int TABLE = 48;
	public static final int ICON = 49;
	public static final int GEOIMAGE = 50;
	public static final int EPS = 51;
	public static final int SCALE = 52;
	public static final int ROTATE = 53;
	public static final int WORLDS = 54;
	public static final int PROJECT = 55;
	public static final int DATASET = 56;
	public static final int FETCH = 57;
	public static final int NEWPAGE = 58;
	public static final int ENDPAGE = 59;
	public static final int PRINT = 60;
	public static final int LOCAL = 61;
	public static final int LET = 62;
	public static final int EVAL = 63;
	public static final int KEY = 64;
	public static final int LEGEND = 65;
	public static final int MIMETYPE = 66;
