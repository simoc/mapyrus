...
public class Statement
{
	...
	public static final int ADDPATH = 19;
	public static final int CLEARPATH = 20;
	public static final int CLOSEPATH = 21;
	public static final int SAMPLEPATH = 22;
	public static final int STRIPEPATH = 23;
	public static final int SHIFTPATH = 24;
	public static final int SINKHOLE = 25;
	public static final int GUILLOTINE = 26;
	public static final int STROKE = 27;
	public static final int FILL = 28;
	public static final int PROTECT = 29;
	public static final int UNPROTECT = 30;
	public static final int CLIP = 31;
	...
	public static final int DATASET = 38;
	public static final int FETCH = 39;
	public static final int NEWPAGE = 40;
	...
	public static final int LEGEND = 45;
