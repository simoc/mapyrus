...
public class Statement
{
	...
	public static final int ADDPATH = 29;
	public static final int CLEARPATH = 30;
	public static final int CLOSEPATH = 31;
	public static final int SAMPLEPATH = 32;
	public static final int STRIPEPATH = 33;
	public static final int SHIFTPATH = 34;
	public static final int PARALLELPATH = 35;
	public static final int SELECTPATH = 36;
	public static final int SINKHOLE = 37;
	public static final int GUILLOTINE = 38;
	public static final int STROKE = 39;
	public static final int FILL = 40;
	public static final int GRADIENTFILL = 41;
	public static final int PROTECT = 42;
	public static final int UNPROTECT = 43;
	public static final int CLIP = 44;
	public static final int LABEL = 45;
	public static final int FLOWLABEL = 46;
	public static final int TABLE = 47;
	public static final int ICON = 48;
	public static final int GEOIMAGE = 49;
	public static final int EPS = 50;
	public static final int SCALE = 51;
	public static final int ROTATE = 52;
	public static final int WORLDS = 53;
	public static final int PROJECT = 54;
	public static final int DATASET = 55;
	public static final int FETCH = 56;
	public static final int NEWPAGE = 57;
	public static final int ENDPAGE = 58;
	public static final int PRINT = 59;
	public static final int LOCAL = 60;
	public static final int LET = 61;
	public static final int EVAL = 62;
	public static final int KEY = 63;
	public static final int LEGEND = 64;
	public static final int MIMETYPE = 65;
