...
public class Statement
{
	...
	public static final int ADDPATH = 21;
	public static final int CLEARPATH = 22;
	public static final int CLOSEPATH = 23;
	public static final int SAMPLEPATH = 24;
	public static final int STRIPEPATH = 25;
	public static final int SHIFTPATH = 26;
	public static final int SINKHOLE = 27;
	public static final int GUILLOTINE = 28;
	public static final int STROKE = 29;
	public static final int FILL = 30;
	public static final int PROTECT = 31;
	public static final int UNPROTECT = 32;
	public static final int CLIP = 33;
	public static final int LABEL = 34;
	public static final int ICON = 35;
	public static final int SCALE = 36;
	public static final int ROTATE = 37;
	public static final int WORLDS = 38;
	public static final int PROJECT = 39;
	public static final int DATASET = 40;
	public static final int FETCH = 41;
	public static final int NEWPAGE = 42;
