...
public class Statement
{
	...
	public static final int WEDGE = 22;
	public static final int SPIRAL = 23;
	public static final int BOX = 24;
	public static final int ROUNDEDBOX = 25;
	public static final int BOX3D = 26;
	public static final int HEXAGON = 27;
	public static final int PENTAGON = 28;
	public static final int TRIANGLE = 29;
	public static final int STAR = 30;
	public static final int ADDPATH = 31;
	public static final int CLEARPATH = 32;
	public static final int CLOSEPATH = 33;
	public static final int SAMPLEPATH = 34;
	public static final int STRIPEPATH = 35;
	public static final int SHIFTPATH = 36;
	public static final int PARALLELPATH = 37;
	public static final int SELECTPATH = 38;
	public static final int SINKHOLE = 39;
	public static final int GUILLOTINE = 40;
	public static final int STROKE = 41;
	public static final int FILL = 42;
	public static final int GRADIENTFILL = 43;
	public static final int PROTECT = 44;
	public static final int UNPROTECT = 45;
	public static final int CLIP = 46;
	public static final int LABEL = 47;
	public static final int FLOWLABEL = 48;
	public static final int TABLE = 49;
	public static final int ICON = 50;
	public static final int GEOIMAGE = 51;
	public static final int EPS = 52;
	public static final int SCALE = 53;
	public static final int ROTATE = 54;
	public static final int WORLDS = 55;
	public static final int PROJECT = 56;
	public static final int DATASET = 57;
	public static final int FETCH = 58;
	public static final int NEWPAGE = 59;
	public static final int ENDPAGE = 60;
	public static final int PRINT = 61;
	public static final int LOCAL = 62;
	public static final int LET = 63;
	public static final int EVAL = 64;
	public static final int KEY = 65;
	public static final int LEGEND = 66;
	public static final int MIMETYPE = 67;
