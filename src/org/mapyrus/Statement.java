...
public class Statement
{
	...
	public static final int SPIRAL = 24;
	public static final int BOX = 25;
	public static final int ROUNDEDBOX = 26;
	public static final int BOX3D = 27;
	public static final int HEXAGON = 28;
	public static final int PENTAGON = 29;
	public static final int TRIANGLE = 30;
	public static final int STAR = 31;
	public static final int ADDPATH = 32;
	public static final int CLEARPATH = 33;
	public static final int CLOSEPATH = 34;
	public static final int SAMPLEPATH = 35;
	public static final int STRIPEPATH = 36;
	public static final int SHIFTPATH = 37;
	public static final int PARALLELPATH = 38;
	public static final int SELECTPATH = 39;
	public static final int SINKHOLE = 40;
	public static final int GUILLOTINE = 41;
	public static final int STROKE = 42;
	public static final int FILL = 43;
	public static final int GRADIENTFILL = 44;
	public static final int PROTECT = 45;
	public static final int UNPROTECT = 46;
	public static final int CLIP = 47;
	public static final int LABEL = 48;
	public static final int FLOWLABEL = 49;
	public static final int TABLE = 50;
	public static final int ICON = 51;
	public static final int GEOIMAGE = 52;
	public static final int EPS = 53;
	public static final int SCALE = 54;
	public static final int ROTATE = 55;
	public static final int WORLDS = 56;
	public static final int PROJECT = 57;
	public static final int DATASET = 58;
	public static final int FETCH = 59;
	public static final int NEWPAGE = 60;
	public static final int ENDPAGE = 61;
	public static final int PRINT = 62;
	public static final int LOCAL = 63;
	...
	public static final int MIMETYPE = 68;
