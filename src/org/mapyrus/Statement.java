...
public class Statement
{
	...
	public static final int ADDPATH = 20;
	public static final int CLEARPATH = 21;
	public static final int CLOSEPATH = 22;
	public static final int SAMPLEPATH = 23;
	public static final int STRIPEPATH = 24;
	public static final int SHIFTPATH = 25;
	public static final int SINKHOLE = 26;
	public static final int GUILLOTINE = 27;
	public static final int STROKE = 28;
	public static final int FILL = 29;
	public static final int PROTECT = 30;
	public static final int UNPROTECT = 31;
	...
	public static final int ROTATE = 36;
	public static final int WORLDS = 37;
	public static final int PROJECT = 38;
	public static final int DATASET = 39;
	public static final int FETCH = 40;
	public static final int NEWPAGE = 41;
	...
	public static final int LEGEND = 46;
