...
public class Statement
{
	...
	public static final int EVENTSCRIPT = 45;
	public static final int PROTECT = 46;
	public static final int UNPROTECT = 47;
	public static final int CLIP = 48;
	public static final int LABEL = 49;
	public static final int FLOWLABEL = 50;
	public static final int TABLE = 51;
	public static final int ICON = 52;
	public static final int GEOIMAGE = 53;
	public static final int EPS = 54;
	public static final int SCALE = 55;
	public static final int ROTATE = 56;
	public static final int WORLDS = 57;
	public static final int PROJECT = 58;
	public static final int DATASET = 59;
