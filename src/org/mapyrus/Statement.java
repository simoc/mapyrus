...
public class Statement
{
	...
	public static final int ROUNDEDBOX = 23;
	public static final int BOX3D = 24;
	public static final int HEXAGON = 25;
	public static final int TRIANGLE = 26;
	public static final int STAR = 27;
	public static final int ADDPATH = 28;
	public static final int CLEARPATH = 29;
	public static final int CLOSEPATH = 30;
	public static final int SAMPLEPATH = 31;
	public static final int STRIPEPATH = 32;
	public static final int SHIFTPATH = 33;
	public static final int PARALLELPATH = 34;
	public static final int SELECTPATH = 35;
	public static final int SINKHOLE = 36;
	public static final int GUILLOTINE = 37;
	public static final int STROKE = 38;
	public static final int FILL = 39;
	public static final int GRADIENTFILL = 40;
	public static final int PROTECT = 41;
	public static final int UNPROTECT = 42;
	public static final int CLIP = 43;
	public static final int LABEL = 44;
	public static final int FLOWLABEL = 45;
	public static final int TABLE = 46;
	public static final int ICON = 47;
	public static final int GEOIMAGE = 48;
	public static final int EPS = 49;
	public static final int SCALE = 50;
	public static final int ROTATE = 51;
	public static final int WORLDS = 52;
	public static final int PROJECT = 53;
	public static final int DATASET = 54;
	public static final int FETCH = 55;
	public static final int NEWPAGE = 56;
	public static final int ENDPAGE = 57;
	public static final int PRINT = 58;
	public static final int LOCAL = 59;
	public static final int LET = 60;
	public static final int EVAL = 61;
	public static final int KEY = 62;
	public static final int LEGEND = 63;
	public static final int MIMETYPE = 64;
