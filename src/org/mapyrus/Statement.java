...
public class Statement
{
	...
	public static final int WEDGE = 19;
	public static final int BOX = 20;
	public static final int ROUNDEDBOX = 21;
	public static final int HEXAGON = 22;
	public static final int TRIANGLE = 23;
	public static final int STAR = 24;
	public static final int ADDPATH = 25;
	public static final int CLEARPATH = 26;
	public static final int CLOSEPATH = 27;
	public static final int SAMPLEPATH = 28;
	public static final int STRIPEPATH = 29;
	public static final int SHIFTPATH = 30;
	public static final int PARALLELPATH = 31;
	public static final int SINKHOLE = 32;
	public static final int GUILLOTINE = 33;
	public static final int STROKE = 34;
	public static final int FILL = 35;
	public static final int PROTECT = 36;
	public static final int UNPROTECT = 37;
	public static final int CLIP = 38;
	public static final int LABEL = 39;
	public static final int FLOWLABEL = 40;
	...
	public static final int DATASET = 46;
	public static final int FETCH = 47;
	public static final int NEWPAGE = 48;
	...
	public static final int MIMETYPE = 55;
