...
public class Statement
{
	...
	public static final int ROUNDEDBOX = 20;
	public static final int HEXAGON = 21;
	public static final int TRIANGLE = 22;
	public static final int STAR = 23;
	public static final int ADDPATH = 24;
	public static final int CLEARPATH = 25;
	public static final int CLOSEPATH = 26;
	public static final int SAMPLEPATH = 27;
	public static final int STRIPEPATH = 28;
	public static final int SHIFTPATH = 29;
	public static final int PARALLELPATH = 30;
	public static final int SINKHOLE = 31;
	public static final int GUILLOTINE = 32;
	public static final int STROKE = 33;
	public static final int FILL = 34;
	public static final int PROTECT = 35;
	public static final int UNPROTECT = 36;
	public static final int CLIP = 37;
	public static final int LABEL = 38;
	public static final int FLOWLABEL = 39;
	public static final int ICON = 40;
	public static final int SCALE = 41;
	public static final int ROTATE = 42;
	public static final int WORLDS = 43;
	public static final int PROJECT = 44;
	public static final int DATASET = 45;
	public static final int FETCH = 46;
	public static final int NEWPAGE = 47;
