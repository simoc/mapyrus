...
/**
 * Function returning descent of string if it were displayed on page.
 * For example, stringdescent("gyp") = -6.
 */
public class Stringdescent implements Function
{
	/**
