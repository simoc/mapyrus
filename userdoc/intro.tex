...
\begin{figure}
%BEGINHTML
% Leave blank line below to force paragraph break in HTML so that
% figures are split into two rows.
...
Integration with the freely-available
\textit{ogrinfo} program, part of the OGR library from
(\texttt{http://openev.sourceforge.net}).
This program provides access to many different GIS data formats.
