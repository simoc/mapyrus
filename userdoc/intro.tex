...
JTS Topology Suite
\footnote{Available from http://www.tsusiatsoftware.net/jts/main.html}.
...
graph images to a web application such as OpenLayers
\footnote{Available from http://www.openlayers.org}
via HTTP requests.

\item
As a Java Servlet in Apache Tomcat,
