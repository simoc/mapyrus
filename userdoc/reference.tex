...
\begin{alltt}
import [\textit{xMin}, \textit{yMin}, \textit{xMax}, \textit{yMax}]
\end{alltt}
...
\begin{alltt}
newpage \textit{format}, \textit{filename}, \textit{width}, \textit{height}, \textit{resolution}, \textit{extras}
\end{alltt}
...
which ISO Latin1 character encoding is required.  Use ISO Latin1 encoding
...
Requests for files with no suffix, or with unknown file suffix are interpreted
