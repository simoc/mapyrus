...
The PostScript and PDF languages do not contain any functions for setting
transparency.
All colors in PostScript, Encapsulated PostScript and PDF
...
PostScript, Encapsulated PostScript, PDF &
