...
\begin{alltt}
http://localhost:8080/mapyrus/?commands=print+Mapyrus.version
\end{alltt}
\begin{alltt}
http://localhost:8080/mapyrus/?commands=mimetype+"image%2Fpng"%0D \textbackslash
  newpage+"png"%2C"-"%2C50%2C50%2C"background%3Dred"
\end{alltt}

Normally, the Mapyrus commands in the HTTP request will be generated
programmatically or entered in an HTML form.
