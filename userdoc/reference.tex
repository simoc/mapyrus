...
PNG, JPEG images and Encapsulated PostScript images &
...
\begin{alltt}
worlds \textit{wx1}, \textit{wy1}, \textit{wx2}, \textit{wy2} [, \texttt{"units=\textit{u}"}]
worlds \textit{wx1}, \textit{wy1}, \textit{wx2}, \textit{wy2}, \textit{px1}, \textit{py1}, \textit{px2}, \textit{py2} [, \texttt{"units=\textit{u}"}]
\end{alltt}
...
\textit{u} defines the units of the world coordinates,
