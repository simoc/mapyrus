...
The type of the next legend entry to be displayed by the
\texttt{legend} command.  Either
\texttt{point}, \texttt{line}, \texttt{zigzag} or \texttt{box}. \\
...
\textit{size} is the optional size for the icon in millimetres.  If no size
...
Javadoc API documentation for Mapyrus is included in the
