...
\textit{X-Windows Virtual Framebuffer}
from
\texttt{http://www.xvfb.org}).
\item
...
PostScript is a language for defining the layout of shapes on a page.
The PostScript language does not contain any functions for setting
transparency.
All colors in a PostScript file will be opaque.
