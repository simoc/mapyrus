...
Transparent colors are only available for JPEG, PNG, PPM, SVG
...
\textit{filename} or
\textit{url}
is the name of a GIF, JPEG, PNG or PPM format image file.
...
containing the icon.
The icon must be either \texttt{GIF}, \texttt{JPEG},
...
JPEG, PNG, PPM images, output to a window on screen
