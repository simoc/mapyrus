...
ttf2pt1\footnote{Available from http://ttf2pt1.sourceforge.net}.  The following
command converts the font in the file \texttt{BEANTOWN.TTF} to a PostScript
Type 1 font in file \texttt{BEANTOWN.pfa}.
