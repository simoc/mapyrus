...
Reading data from a MapInfo MIF format file follows the same pattern as reading
...
Another solution is to read from a relational database within Mapyrus
...
\caption{Updating Ann Existing Output File}
