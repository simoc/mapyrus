...
The included file \texttt{piechart.mapyrus} (available in the \texttt{doc}
...
Two \texttt{interpret()} methods are provided.
One of the methods is passed a
\texttt{java.awt.image.BufferedImage} to set as the
initial output page.
...
m2.interpret(commands2, System.out, bi, "");
m2.close();
\end{verbatim}
